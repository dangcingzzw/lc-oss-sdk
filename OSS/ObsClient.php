 ...
 * @method Model sharpenOperation(array $args = []);
 * @method Model interlaceOperation(array $args = []);
 * @method Model indexcropOperation(array $args = []);
 * @method Model circleOperation(array $args = []);
 * @method Model roundedCornersOperation(array $args = []);
 * @method Model getInfoOperation(array $args = []);
 * @method Model blindWatermarkOperation(array $args = []);
 * @method Model watermarkOperation(array $args = []);
